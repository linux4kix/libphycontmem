...
struct mem_handle_phycontmem* pmem_malloc(int size);	//return handle. if NULL, fail
int pmem_free(struct mem_handle_phycontmem* handle);		//return 0 is ok, other value fail
