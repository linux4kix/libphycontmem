...
struct mem_handle_phycontmem* ion_malloc(int size);	//return handle. if NULL, fail
int ion_free(struct mem_handle_phycontmem* handle);		//return 0 is ok, other value fail
